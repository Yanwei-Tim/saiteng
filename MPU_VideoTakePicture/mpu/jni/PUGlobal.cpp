...
const Model PUGlobal::s_androidModel[] = {{ "SM-N9002", 1 }, { "SM-N9008V", 1 },
		{ 'GT-I9508', 1 }, { "GT-I9505", 1 },{ "GT-N7108D", 1 },{ "GT-I9500", 1 },{ "GT-I9300", 1 } };
...
void PUGlobal::login(RegisterInfo* info) {
	...
	char *cameraName[] = { "no camera", "back camera", "front camera" };
