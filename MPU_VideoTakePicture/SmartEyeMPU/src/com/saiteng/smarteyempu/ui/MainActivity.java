	...
	private OnClickListener viewClickListenser = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.signin_button: {
				...
				saveLastConfig();
                //加载配置项 启动拍摄服务。
				Intent recordFloatViewService = new Intent();
				recordFloatViewService.setClass(MainActivity.this, FloatViewService.class);
				MainActivity.this.startActivity(recordFloatViewService);
