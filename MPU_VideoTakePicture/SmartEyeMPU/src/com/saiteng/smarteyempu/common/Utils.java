...
public class Utils {
	private static final String PATH = "/MPU/.video";
	...
	public static String getPicturePath(Context context){
		File ExtSDPath = new File( ExtSDDir + Pic_PATH );
		File IntSDPath = new File( IntSDDir  + Pic_PATH );
		if (!ExtSDPath.exists()) {
	...
	public static String generateFileName() {
		...
		if (ExtSD.exists()) {
			return  ExtSDDir + PATH + "/."
					+ simpleDateFormate.format(new Date());
