...
public class WebSocketMessage {
   ...
   /// WebSockets List message to send or received.
   public static class ListMessage extends Message {

      public ArrayList<String> mPayload;

      ListMessage(ArrayList<String> payload) {
         mPayload = payload;
      }
   }
