...
NDK=/home/smartdu/Desktop/workspace/android-ndk-r4
PLATFORM=$NDK/build/platforms/android-8/arch-arm/
PREBUILT=$NDK/build/prebuilt/linux-x86/arm-eabi-4.4.0
...
./configure --target-os=linux \
    ...
    --disable-shared \
    --enable-static \
    --extra-ldflags="-Wl,-rpath-link=$PLATFORM/usr/lib -L$PLATFORM/usr/lib  -nostdlib -lc -lm -ldl -llog -L." \
    --enable-parsers \
    --enable-decoders \
	--disable-encoders \
