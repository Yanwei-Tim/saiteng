...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/home/smartdu/Desktop/workspace/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc --cross-prefix=/home/smartdu/Desktop/workspace/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi- --nm=/home/smartdu/Desktop/workspace/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-nm --sysroot=/home/smartdu/Desktop/workspace/android-ndk-r4/build/platforms/android-8/arch-arm/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=/home/smartdu/Desktop/workspace/android-ndk-r4/build/platforms/android-8/arch-arm//usr/lib -L/home/smartdu/Desktop/workspace/android-ndk-r4/build/platforms/android-8/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog -L.' --enable-parsers --enable-decoders --disable-encoders --enable-encoder=adpcm_g726 --enable-demuxers --enable-swscale --disable-ffplay --disable-ffprobe --disable-ffserver --enable-network --enable-indevs --disable-bsfs --disable-filters --enable-protocols --enable-asm --enable-neon"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define FFMPEG_DATADIR "./android/armv7-a/share/ffmpeg"
#define AVCONV_DATADIR "./android/armv7-a/share/ffmpeg"
#define CC_IDENT "gcc 4.4.0 (GCC)"
