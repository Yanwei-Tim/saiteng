...
typedef enum pjsip_method_e
{
	...
	PJSIP_QUERY_METHOD,		/**< QUERY method.                  */
	PJSIP_CONTROL_METHOD,		/**< CONTROL method.                  */
	PJSIP_NOTIFY_METHOD,
	PJSIP_KEEPALIVE_METHOD,
...
/** QUERY method constant. */
PJ_DECL_DATA(const pjsip_method) pjsip_query_method;

/** CONTROL method constant. */
PJ_DECL_DATA(const pjsip_method) pjsip_control_method;

/** NOTIFY method constant. */
PJ_DECL_DATA(const pjsip_method) pjsip_notify_method;

/** KEEPALIVE method constant. */
PJ_DECL_DATA(const pjsip_method) pjsip_keepalive_method;

/** OTHER method constant. */
PJ_DECL_DATA(const pjsip_method) pjsip_other_method;
...
/** Get QUERY method constant. */
PJ_DECL(const pjsip_method*) pjsip_get_query_method(void);
/** Get CONTROL method constant. */
PJ_DECL(const pjsip_method*) pjsip_get_control_method(void);
/** Get NOTIFY method constant. */
PJ_DECL(const pjsip_method*) pjsip_get_notify_method(void);
/** Get KEEPALIVE method constant. */
PJ_DECL(const pjsip_method*) pjsip_get_keepalive_method(void);
/** Get OTHER method constant. */
PJ_DECL(const pjsip_method*) pjsip_get_other_method(void);
...
/* **************************************************************************/
/**
 * custom Payload-Offset header.
 */
typedef struct _pjsip_payload_offset_hdr
{
	PJSIP_DECL_HDR_MEMBER(struct _pjsip_payload_offset_hdr);
	int offset;
	int endflag;
	int total_length;
} pjsip_payload_offset_hdr;

/**
 * Create a new Payload-Offset header.
 *
 * @param pool	    The pool.
 * @return	    A new "Payload-Offset" header instance.
 */
PJ_DECL(pjsip_payload_offset_hdr*) pjsip_payload_offset_hdr_create( pj_pool_t *pool );
 ...
 *		    location as the mem argument.
 */
PJ_DECL(pjsip_payload_offset_hdr*) pjsip_payload_offset_hdr_init( pj_pool_t *pool,
					    void *mem );

/* **************************************************************************/
/**
 * custom Sub-Method header.
 */
typedef struct _pjsip_sub_method_hdr
{
	PJSIP_DECL_HDR_MEMBER(struct _pjsip_sub_method_hdr);
	pj_str_t sub_method;
} pjsip_sub_method_hdr;

/**
 * Create a new Sub-Method header.
 *
 * @param pool	    The pool.
 * @return	    A new "Payload-Offset" header instance.
 */
PJ_DECL(pjsip_sub_method_hdr*) pjsip_sub_method_hdr_create( pj_pool_t *pool );
 ...
 *		    location as the mem argument.
 */
PJ_DECL(pjsip_sub_method_hdr*) pjsip_sub_method_hdr_init( pj_pool_t *pool,
					    void *mem );

/* **************************************************************************/
/**
 * custom Applier-ID header.
 */
typedef struct _pjsip_applier_id_hdr
{
	PJSIP_DECL_HDR_MEMBER(struct _pjsip_applier_id_hdr);
	int applier_id;
} pjsip_applier_id_hdr;

/* **************************************************************************/
/**
 * custom Subsequent header.
 */
typedef pjsip_generic_int_hdr pjsip_subsequent_hdr;
 ...
 * @return	    A new "Payload-Offset" header instance.
 */
PJ_DECL(pjsip_applier_id_hdr*) pjsip_applier_id_hdr_create( pj_pool_t *pool );
 ...
 *		    location as the mem argument.
 */
PJ_DECL(pjsip_applier_id_hdr*) pjsip_applier_id_hdr_init( pj_pool_t *pool,
					    void *mem );

PJ_DECL(pjsip_subsequent_hdr*) pjsip_subsequent_hdr_create( pj_pool_t *pool );

PJ_DECL(pjsip_subsequent_hdr*) pjsip_subsequent_hdr_init( pj_pool_t *pool, void *mem );
